...
- 地图：20 × 15 像素格、每格 30 像素（整图 600 × 450，单屏适配、无需移动镜头），四条沿 Catmull-Rom 样条蜿蜒的弯曲路径从四边入口汇向 IQ 结晶；路线深色、空地无色，建筑物不得落在路线上。
...
- 3 种兵营：冰晶近卫、雾矢射手、暴雪术士，占地 3×3，只在交战阶段召唤单位；波次结束后存活兵种回到出生兵营附近 7×7 格内驻扎。
