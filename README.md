...
- 大地图：256 × 192 像素格、每格 8 像素，四条沿 Catmull-Rom 样条蜿蜒的弯曲路径从四边入口汇向 IQ 结晶；路线深色、空地无色，建筑物不得落在路线上。
...
- 3 种防御塔：冰锥单体、雾凇范围减速、⑨式冰炮重型溅射；防御塔占地为五行 13531 结构（3×3 菱形）。
- 3 种兵营：冰晶近卫、雾矢射手、暴雪术士，占地 3×3，只在交战阶段召唤单位；波次结束后存活兵种回到出生兵营附近 7×7 像素内驻扎。
...
- 数值曲线：第二波起敌军数量大幅上调，友军与防御塔伤害整体下调约 25%（×0.75），寒气自然增长速度较早期版本降低 50%。
...
BATTLE_OK spawned=20 alive=0 allies=4 hp=0/190
